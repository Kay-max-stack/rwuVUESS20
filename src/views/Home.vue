<template>
  <div>
    <!--p>This jumbotron template is borrowed from https://getbootstrap.com/docs/4.0/components/jumbotron/ and edited by ourselves to fit the needs</p--> 
    <section id="overview">
...
export default {
  ...
  data: function() {
    return{
      ...
      aboutDescription: 'In der About Seite findet man weiterführende Links über die Frameworks die Hochschule',
      show1: false,
      show2: false,
      show3: false,
    };
